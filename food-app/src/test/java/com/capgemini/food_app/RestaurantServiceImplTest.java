...
class RestaurantServiceImplTest {
    ...
    void testGetAllRestaurants() {
        List<Restaurant> restaurants = Arrays.asList(
                ...
                new Restaurant(2L, "Res2", "Loc2", "456", 20L, "img2.jpg", new ArrayList<>())
        );
    ...
    void testGetRestaurantById_Success() {
        Restaurant restaurant = new Restaurant(1L, "Res1", "Loc1", "123", 10L, "img1.jpg", new ArrayList<>());
    ...
    void testCreateRestaurant() throws IOException {
        ...
        Restaurant saved = new Restaurant(1L, "Res1", "Loc1", "123", 10L, "file.jpg", new ArrayList<>());
    ...
    void testUpdateRestaurant() throws IOException {
        Restaurant existing = new Restaurant(1L, "OldName", "OldLoc", "111", 10L, "old.jpg", new ArrayList<>());
    ...
    void testDeleteRestaurant() {
        Restaurant restaurant = new Restaurant(1L, "Res1", "Loc1", "123", 10L, "img.jpg", new ArrayList<>());
        when(restaurantRepository.findById(1L)).thenReturn(Optional.of(restaurant));
